...
import { changeCurrentPassword, forgotPasswordRequest, getCurrentUser, login, refreshAccessToken, registerUser, resendEmailVerification, resetForgotPassword, verifyEmail } from "../controllers/auth.controllers.js"
...
router
    ...
    .post(userForgotPasswordValidator(),
    validate,
    resetForgotPassword)
